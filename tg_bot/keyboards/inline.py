...
from ..tmp import KEYBOARD_WIDTH, LEXICON
from ..tmp import get_catigories, get_documents
...
async def make_file_page_keyboard(category: str, document_name: str, **kwargs) -> InlineKeyboardMarkup:
    '''
